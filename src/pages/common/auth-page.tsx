...
//       setError('Login successful!'); // Show success
//     } catch (err: any) {
...
//         formData.append('license_file', registerData.license); // Match backend field
//       }
//     }
...
//       setActiveTab('login');
//       setError('Registration successful!'); // Show success
//     } catch (err: any) {
...
//                   </div>
//                 </div>
//                 {error && <p className="text-red-500 text-sm">{error}</p>} {/* Show errors/success */}
